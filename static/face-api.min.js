!(function (t, e) {
	...
	function ft(t, e, n) {
		return I(
			Array.isArray(t)
				? parseFloat(t[0].toFixed(ht)) +
						' + ' +
						parseFloat(t[1].toFixed(ht)) +
						'j'
				: G(t)
				? "'" + t + "'"
				: 'bool' === n
	...
	var bt =
		...
		(wt.prototype.split = function (t, e) {
			return (
				void 0 === e && (e = 0), this.throwIfDisposed(), gt.split(this, t, e)
			);
		}),
		...
		(wt.prototype.softmax = function (t) {
			return (
				void 0 === t && (t = -1), this.throwIfDisposed(), gt.softmax(this, t)
			);
		}),
	...
	Object.defineProperty(Ft, Symbol.hasInstance, {
		value: function (t) {
			return (
				t instanceof bt && null != t.assign && t.assign instanceof Function
			);
		},
	}),
		((Nt = Ct = Ct || {}).R0 = 'R0'),
		...
		t in ne ||
			(ne[t] = (function (e) {
				...
				return (
					...
					1 === e
						? t.getContext('webgl', re) ||
						  t.getContext('experimental-webgl', re)
	...
	function $e(t) {
		...
		if (1 === t)
			return (
				!!Ke(e, 'OES_texture_float') &&
				!!Ke(e, 'WEBGL_color_buffer_float') &&
				Je(e)
			);
	...
	function la(t, e, n, r) {
		return (
			...
			ke(t, e, n, 'clipSpacePos', r, 3, 20, 0) &&
				ke(t, e, n, 'uv', r, 2, 20, 12)
		);
	}
	...
	var ya = Object.freeze({
		...
		xa =
			...
			(ba.prototype.createFloat16PackedMatrixTexture = function (t, e) {
				return (
					this.throwIfDisposed(),
					ca(this.gl, this.debug, t, e, this.textureConfig)
				);
			}),
			...
			(ba.prototype.downloadPackedMatrixFromBuffer = function (
				t,
				e,
				n,
				r,
			...
			(ba.prototype.debugValidate = function () {
				null != this.program && we(this.gl, this.debug, this.program),
					Me(this.gl);
			}),
	...
	function rs(t, e) {
		...
		var n;
		if (t === Jt.DOWNLOAD || t === Jt.PIXELS)
			return Qt.PACKED_4X1_UNSIGNED_BYTE;
				...
				return y(this, void 0, void 0, function () {
					...
					return R(this, function (t) {
						switch (t.label) {
							...
							case 3:
								return (
									(m = t.sent()), (g = m[0]), (y = m[1]), (v = Mo(g, y)), [3, 5]
								);
							case 4:
								(v =
									null == f
										...
										: ((x = L(o)),
										  this.gpgpu.downloadFloat32MatrixFromBuffer(f, x))),
									(t.label = 5);
							case 5:
								return (
						...
						switch (t.label) {
							case 0:
								return (
									...
									0 <
									_().getNumber('WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_RELIABLE')
										? [4, Promise.all(o)]
										: [3, 2]
								);
							case 1:
			...
			(Ts.prototype.getCPUBackend = function () {
				return _().getBool('WEBGL_CPU_FORWARD')
					? (null == this.cpuBackend &&
							(this.cpuBackend = Kt.findBackend('cpu')),
					  this.cpuBackend)
					: null;
			}),
				...
				return Kt.runKernelFunc(
					...
					function (t, e) {
						...
						return {
							$x: function () {
								return t
									.divStrict(kn(1).sub(n.toFloat().square()).sqrt())
									.neg();
							},
						};
					}
			...
			Nh = [
				{
					...
					kernelFunc: function (t) {
						...
						(s || a) &&
							(null == Sh &&
								(Sh = document.createElement('canvas').getContext('2d')),
							(Sh.canvas.width = c),
							(Sh.canvas.height = l),
				...
				return R(this, function (t) {
					switch (t.label) {
						...
						case 1:
							return (
								(u = t.sent()),
								f && s ? [4, $h.getManager(i).removeModel(a)] : [3, 3]
							);
						case 2:
							t.sent(), (t.label = 3);
						case 3:
						...
						case 4:
							return (
								(c = t.sent()),
								!f || s ? [3, 6] : [4, $h.getManager(i).removeModel(a)]
							);
						case 5:
							t.sent(), (t.label = 6);
						case 6:
		...
		Gf = Object.freeze({
			...
			removeModel: function (n) {
				return y(this, void 0, void 0, function () {
					...
					return R(this, function (t) {
						return (
							(e = Zh(n)), [2, $h.getManager(e.scheme).removeModel(e.path)]
						);
					});
				});
			},
	...
	var Wd,
		...
		Ud =
			...
			(Vd.assertIsValidPredictedBox = function (t, e) {
				if (
					(Od.assertIsValidLabeledBox(t, e), !ed(t.score) || !ed(t.classScore))
				)
					throw new Error(
						e +
	...
	function ev(t) {
		return tv.isNodejs() || 'string' != typeof t
			? t
			...
			return (
				...
				nn(function () {
					var t = Zp(i.batchSize, 0, 1).map(function (t) {
						...
						if (e instanceof tv.getEnv().Canvas)
							return Kf.fromPixels(gv(e, r, o));
						throw new Error(
							...
							[
								...
								u
									...
									.map(function (t) {
										...
										return (
											nv(i).putImageData(a.getImageData(e, n, r, o), 0, 0), i
										);
									}),
							]
						);
		...
		return (
			...
			nn(function () {
				var t = dl(
						a
							? Ou(
									Ec(o, i.conv0.filters, s ? [2, 2] : [1, 1], 'same'),
									i.conv0.bias
							  )
	...
	var Hv,
		qv =
			...
			(jv.prototype.forwardInput = function (e) {
				...
				return nn(function () {
					var t = Tv(
						yd(e.toBatchTensor(112, !0), [122.782, 117.001, 104.298]).div(
							kn(255)
						),
						n.dense0,
						!0
	...
	function rm(t) {
		return (
			void 0 === t && (t = new qv()),
			em.call(this, 'FaceExpressionNet', t) || this
		);
	}
	function om(t) {
	...
	function Sm(t) {
		return (
			void 0 === t && (t = new qv()),
			Rm.call(this, 'FaceLandmark68Net', t) || this
		);
	}
	var Dm,
		Am =
	...
	function ag(e, n) {
		return nn(function () {
			var t = e.shape[0];
			return {
				boxPredictionEncoding: Tr(Nv(e, n.box_encoding_predictor), [
					t,
					-1,
					1,
					4,
					...
					return (function (o, i, a) {
						return nn(function () {
							...
							var n = ru(Xc(i, [0, 0, 1], [-1, -1, -1])),
								r = Xc(n, [0, 0, 0], [-1, -1, 1]);
							return (
								(r = Tr(r, [t, r.shape[1]])), { boxes: Br(e), scores: Br(r) }
							);
						});
		...
		Ag =
			...
			(Tg.prototype.runTinyYolov2 = function (t, e) {
				...
				return (
					...
					Nv(
						(n = Eg(
							(n = Eg((n = Gc(n, [2, 2], [1, 1], 'same')), e.conv6)),
							e.conv7
						)),
						e.conv8,
						'valid',
			...
			(Tg.prototype.forwardInput = function (e, n) {
				...
				return nn(function () {
					...
					return (
						(t = (t = r.config.meanRgb ? yd(t, r.config.meanRgb) : t).div(
							kn(256)
						)),
	...
	function qg(t) {
		var e = [],
			...
			u = i();
		return (
			Fv(t, e), { params: { pnet: a, rnet: s, onet: u }, paramMappings: e }
		);
	}
	function jg(t, e) {
		var n = e[0],
													...
													switch (t.label) {
														case 0:
															return [
																...
																Promise.all(
																	e.map(function (t) {
																		return vy.faceExpressionNet.predictExpressions(
																			t
																		);
																	})
																),
													...
													switch (t.label) {
														case 0:
															return [
																...
																Promise.all(
																	e.map(function (t) {
																		return vy.ageGenderNet.predictAgeAndGender(
																			t
																		);
																	})
																),
					...
					return Wp(this, function (t) {
						switch (t.label) {
							case 0:
								return (
									(n = (e = this).input),
									(r = e.options) instanceof Jm
										? [4, vy.mtcnn.forward(n, r)]
										: [3, 2]
								);
							case 1:
								return [
						...
						switch (t.label) {
							case 0:
								return (
									...
									[
										4,
										wx(e, new Jm(n)).withFaceLandmarks().withFaceDescriptors(),
									]
								);
							case 1:
								return [2, t.sent()];
						...
						switch (t.label) {
							case 0:
								return (
									...
									[
										4,
										wx(e, new kg(n)).withFaceLandmarks().withFaceDescriptors(),
									]
								);
							case 1:
								return [2, t.sent()];
